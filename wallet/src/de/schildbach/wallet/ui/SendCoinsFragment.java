...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
	{
		...
		AutoCompleteAddressAdapter acaa = new AutoCompleteAddressAdapter(activity, null);
		receivingAddressView = (AutoCompleteTextView) view.findViewById(R.id.send_coins_receiving_address);
		receivingAddressView.setAdapter(acaa);
	...
	public class AutoCompleteAddressAdapter extends CursorAdapter
	{
		...
		{
			log.info("Constraints null? {}",constraint);
			return activity.managedQuery(AddressBookProvider.contentUri(activity.getPackageName()), null,
